...
import { GET_PORTOFOLIOS_BY_CATEGORY } from "../gql/portofolio";
                ...
                <Row className="">
                    ...
                    <Col xs={12} sm={12} md={12} lg={6} className=" modal-catalog-content">
                        ...
                        <div className="demo-btn">
                            <a href={data.url} target="_blank" rel="noopener noreferrer" className="btn-kadosoft draw-border "><i className="fas fa-play"></i> Try Our Demo</a>
                        </div>
                    </Col>
        ...
        <>
            <Card className="catalog-card hover-top">
                ...
                <Card.Body>
                    ...
                    {/* <Row className="justify-content-center align-items-center"> */}
                    <button className="btn-kadosoft draw-border" onClick={() => {
                        updateShowModal();
                    }}>View More</button>
                    {/* </Row> */}
                </Card.Body>
...
function CatalogPreview(props) {
    ...
    return (
        <React.Fragment>
            <Row className="px-1 py-0 catalog-card-row justify-content-center align-items-center">
                {data.getPortofoliosByCategory.map((portofolio, index) => (
